...
const Banner = () => {
   return(
      <div className='w-full h-[450px]'>
         ...
         <div className='relative z-20 w-full h-full -top-[190%] ml-36 tracking-wider'>
            <h2 className='w-2/6 mb-10 text-6xl font-bold leading-tight text-zinc-50'>Conheça os nossos produtos</h2>
